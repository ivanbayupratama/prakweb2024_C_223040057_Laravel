    ...
    <div class="sm:p-4 mt-14 sm:mt-0 tracking-wide leading-loose">
        <div class="header mb-">
            <h1 class="text-2xl flex items-center gap-4 mb-10">
                ...
                <div class="span">Edit Blog: <span class="font-extrabold ">{{ $blog->title }}</span></div>
            </h1>
        </div>
        <div class="blogs">
            <form>
                ...
                <div class="mb-6">
                    ...
                    <input type="text" id="default-input"
                        ...
                        required value="{{ $blog->title }}" name="title">
                </div>

                {{-- CONTENT --}}

                <label for="default-input" class="block mb-2 text-sm font-bold text-gray-900 dark:text-white">
                    Content</label>
                <div
                    ...
                    <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                        ...
                        <textarea id="editor" rows="8"
                            ...
                            placeholder="Write an article..." required name="article">{{ $blog->article }}</textarea>
                    </div>
                </div>
                <button type="submit"
